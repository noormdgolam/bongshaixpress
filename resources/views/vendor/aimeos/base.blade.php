	...
	<body class="{{ $page ?? '' }}">
		<nav class="navbar navbar-expand-md navbar-top">
			<a class="navbar-brand" href="/" title="{{ __('To the home page') }}">
				<h1 style="margin:0; font-size: 24px; font-weight: bold; color: #333;">BONGSHAIXPRESS</h1>
			</a>
			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-md-4 footer-right">
						<div class="footer-block">
							<a class="logo" href="/" title="{{ __('To the home page') }}" style="text-decoration: none;">
								<h1 style="margin:0; font-size: 24px; font-weight: bold; color: #fff;">BONGSHAIXPRESS</h1>
							</a>
